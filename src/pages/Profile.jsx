        ...
        {userProfile?.role === 'coach' && (
          <div className="space-y-3">
            ...
            <button
              ...
              className="w-full flex items-center gap-3 p-4 rounded-2xl text-left border border-gray-100"
              style={{ backgroundColor: '#FFFFFF' }}
            >
              <div className="w-11 h-11 rounded-xl flex items-center justify-center" style={{ backgroundColor: '#FEFCE8' }}>
                <Trophy size={20} color="#D4A017" />
              </div>
              <div className="flex-1">
                <h3 className="font-bold" style={{ color: '#0B1528' }}>Find Tournaments</h3>
                <p className="text-xs mt-0.5" style={{ color: '#64748B' }}>Search USSSA, 2D, Perfect Game and more</p>
              </div>
              <ChevronRight size={18} color="#94A3B8" />
            </button>
          </div>
