...
// Scope: 2D Sports Arkansas baseball tournaments only.
//
// Required env vars:
// - BASE44_APP_ID
// - BASE44_ACCESS_TOKEN
...
process.env.SOURCE_FILTER = process.env.SOURCE_FILTER || '2d_sports';
...
console.log('Starting focused tournament sync: 2D Sports Arkansas baseball');
